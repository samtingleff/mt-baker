package st.digitru.mtbaker.client.annotations.test;

import java.util.Arrays;
import java.util.List;

import st.digitru.mtbaker.client.annotations.Configurable;
import st.digitru.mtbaker.client.annotations.ConfigurableField;
